...
# Configuration
WATCHLIST = [
'ABB', 'AUBANK', 'AARTIIND', 'ADANIENT', 'ADANIGREEN', 'ADANIPORTS', 'AMBUJACEM', 'ASHOKLEY', 'ASIANPAINT', 'AUROPHARMA', 'AXISBANK', 'BSOFT', 'BSE', 'BAJAJ-AUTO', 'BAJFINANCE', 'BAJAJFINSV', 'BANDHANBNK', 'BANKBARODA', 'BEL', 'BHARATFORG', 'BHEL', 'BPCL', 'BHARTIARTL', 'BRITANNIA', 'CANBK', 'CDSL', 'TORNTPOWER', 'CIPLA', 'COALINDIA', 'COFORGE', 'DLF', 'DABUR', 'DIVISLAB', 'DIXON', 'DRREDDY', 'GAIL', 'GODREJPROP', 'GRASIM', 'HCLTECH', 'HDFCBANK', 'HDFCLIFE', 'HEROMOTOCO', 'HINDALCO', 'HAL', 'HINDPETRO', 'HINDUNILVR', 'ICICIBANK', 'IDFCFIRSTB', 'ITC', 'IOC', 'IRCTC', 'IRFC', 'INDUSTOWER', 'INDUSINDBK', 'INFY', 'INDIGO', 'JSWSTEEL', 'JINDALSTEL', 'JIOFIN', 'KOTAKBANK', 'LICHSGFIN', 'LTIM', 'LT', 'LUPIN', 'M&MFIN', 'M&M', 'MANAPPURAM', 'MARUTI', 'MCX', 'NMDC', 'NTPC', 'NATIONALUM', 'ONGC', 'OFSS', 'PERSISTENT', 'PETRONET', 'PFC', 'POWERGRID', 'PNB', 'RECLTD', 'RELIANCE', 'SBICARD', 'SBILIFE', 'MOTHERSON', 'SIEMENS', 'SBIN', 'SAIL', 'SUNPHARMA', 'TATACONSUM', 'TATACHEM', 'TCS', 'TATAMOTORS', 'TATAPOWER', 'TATASTEEL', 'TECHM', 'FEDERALBNK', 'INDHOTEL', 'TITAN', 'TRENT', 'UPL', 'ULTRACEMCO', 'VBL', 'VEDL', 'IDEA', 'VOLTAS', 'WIPRO', 'ETERNAL'
]
...
def index():
    ...
    interval_display = []
    for i in HISTORY_INTERVALS:
        if i < 60:
            interval_display.append(f"{i}s")
        else:
            interval_display.append(f"{i//60}m")
...
<body>
    ...
    <script>
        ...
        const intervalDisplay = {{ interval_display|tojson }};
